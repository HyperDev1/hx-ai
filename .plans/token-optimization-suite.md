...
## Overview
Comprehensive token optimization across the HX dispatch pipeline. Six phases targeting
...
### What
Anthropic prompt caching gives 90% savings on cached input tokens. Currently, HX places
...
### Files Modified
- `src/resources/extensions/hx/prompt-cache-optimizer.ts` (NEW)
- `src/resources/extensions/hx/auto-prompts.ts` (modify builders)
- `src/resources/extensions/hx/metrics.ts` (add cache hit rate)
- `src/resources/extensions/hx/tests/prompt-cache-optimizer.test.ts` (NEW)
...
### Files Modified
- `src/resources/extensions/hx/token-counter.ts` (extend)
- `src/resources/extensions/hx/context-budget.ts` (provider-aware ratio)
- `src/resources/extensions/hx/tests/token-counter.test.ts` (NEW)
- `src/resources/extensions/hx/tests/context-budget.test.ts` (extend)
...
- `src/resources/extensions/hx/structured-data-formatter.ts` (NEW)
- `src/resources/extensions/hx/context-store.ts` (add TOON variants)
- `src/resources/extensions/hx/auto-prompts.ts` (use TOON when level != full)
- `src/resources/extensions/hx/tests/structured-data-formatter.test.ts` (NEW)
...
### Files Modified
- `src/resources/extensions/hx/prompt-compressor.ts` (NEW)
- `src/resources/extensions/hx/context-budget.ts` (integrate)
- `src/resources/extensions/hx/preferences.ts` (add compression_strategy)
- `src/resources/extensions/hx/types.ts` (add CompressionStrategy type)
- `src/resources/extensions/hx/tests/prompt-compressor.test.ts` (NEW)
...
### Files Modified
- `src/resources/extensions/hx/semantic-chunker.ts` (NEW)
- `src/resources/extensions/hx/auto-prompts.ts` (integrate with inlineFile)
- `src/resources/extensions/hx/preferences.ts` (add context_selection)
- `src/resources/extensions/hx/types.ts` (add ContextSelectionMode type)
- `src/resources/extensions/hx/tests/semantic-chunker.test.ts` (NEW)
...
### Files Modified
- `src/resources/extensions/hx/summary-distiller.ts` (NEW)
- `src/resources/extensions/hx/auto-prompts.ts` (integrate with inlineDependencySummaries)
- `src/resources/extensions/hx/tests/summary-distiller.test.ts` (NEW)
