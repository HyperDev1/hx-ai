...
### 2. Add descriptions to HX 2nd-level subcommand completions (commands.ts)
- Currently `/hx auto --verbose` shows label only, no description
...
- `src/resources/extensions/hx/commands.ts` — 2nd-level descriptions
