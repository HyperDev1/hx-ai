...
Long-running `/hx auto` sessions exhibit high CPU usage due to multiple compounding issues:
...
**File**: `src/resources/extensions/hx/native-git-bridge.ts`
...
- `src/resources/extensions/hx/auto.ts` (Fixes 1, 3, 5, 6)
- `src/resources/extensions/hx/native-git-bridge.ts` (Fix 2)
- `src/resources/extensions/subagent/isolation.ts` (Fix 4)
- `src/resources/extensions/hx/auto-dashboard.ts` (Fix 7)
- `src/resources/extensions/hx/tests/` (new test files)
