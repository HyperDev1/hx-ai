...
export function QuickPanel() {
  return (
    <div className="space-y-4" data-testid="hx-surface-hx-quick">
      <PanelHeader
        title="Quick Task"
          ...
          <div className="space-y-1.5">
            {[
              ...
              <div key={example} className="flex items-center gap-2 text-[11px]">
                ...
                <code className="font-mono text-muted-foreground">/hx quick {example}</code>
              </div>
            ))}
          </div>
        </div>
...
export function HistoryPanel() {
  ...
  const { loadHistoryData } = useHXWorkspaceActions()
  ...
  return (
    <div className="space-y-4" data-testid="hx-surface-hx-history">
      <PanelHeader
...
export function UndoPanel() {
  const workspace = useHXWorkspaceState()
  const { loadUndoInfo, executeUndoAction } = useHXWorkspaceActions()
  ...
  return (
    <div className="space-y-4" data-testid="hx-surface-hx-undo">
      <PanelHeader
...
export function SteerPanel() {
  const workspace = useHXWorkspaceState()
  const { loadSteerData, sendSteer } = useHXWorkspaceActions()
  ...
  return (
    <div className="space-y-4" data-testid="hx-surface-hx-steer">
      <PanelHeader
        title="Steer"
...
// ═══════════════════════════════════════════════════════════════════════
// 6. INSPECT PANEL — HX database overview
// ═══════════════════════════════════════════════════════════════════════

export function InspectPanel() {
  const workspace = useHXWorkspaceState()
  const { loadInspectData } = useHXWorkspaceActions()
  const state = workspace.commandSurface.remainingCommands.inspect
  const data = state.data as InspectData | null
  const busy = state.phase === "loading"

  return (
    <div className="space-y-4" data-testid="hx-surface-hx-inspect">
      <PanelHeader
...
export function ExportPanel() {
  const workspace = useHXWorkspaceState()
  const { loadExportData } = useHXWorkspaceActions()
  ...
  return (
    <div className="space-y-4" data-testid="hx-surface-hx-export">
      <PanelHeader
        title="Export"
...
export function CleanupPanel() {
  const workspace = useHXWorkspaceState()
  const { loadCleanupData, executeCleanupAction } = useHXWorkspaceActions()
  ...
  return (
    <div className="space-y-4" data-testid="hx-surface-hx-cleanup">
      <PanelHeader
        title="Cleanup"
...
export function QueuePanel() {
  ...
  return (
    <div className="space-y-4" data-testid="hx-surface-hx-queue">
      <PanelHeader
        title="Queue"
...
export function StatusPanel() {
  ...
  return (
    <div className="space-y-4" data-testid="hx-surface-hx-status">
      <PanelHeader
        title="Status"
      ...
      {milestones.length === 0 && (
        <PanelEmpty message="No plan loaded — run /hx to initialize" />
      )}
    </div>
  )
}
