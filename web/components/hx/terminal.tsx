...
function getInputMode(state: ReturnType<typeof useHXWorkspaceState>): InputMode {
...
function inputModePlaceholder(mode: InputMode, state: ReturnType<typeof useHXWorkspaceState>): string {
...
export function Terminal({ className }: TerminalProps) {
  ...
  const { submitInput, sendAbort, sendSteer, consumeEditorTextBuffer } = useHXWorkspaceActions()
