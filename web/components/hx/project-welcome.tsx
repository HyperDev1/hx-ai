...
import type { ProjectDetection } from "@/lib/hx-workspace-store"
  ...
  switch (detection.kind) {
    case "brownfield":
      return {
        ...
        body: "HX will map your codebase and ask a few questions about what you want to build. From there it generates structured milestones and deliverable slices.",
    ...
    case "v1-legacy":
      return {
        ...
        headline: "HX v1 project found",
        body: "This project has a .planning/ folder from an earlier HX version. Migration converts your existing planning data into the new .hx/ format.",
    ...
    case "blank":
      return {
        ...
        body: "This folder is empty. HX will ask what you want to build, then generate a structured plan — milestones broken into deliverable slices with risk-ordered execution.",
        primaryLabel: "Start Project Setup",
        primaryCommand: "/hx",
      }

    // active-hx and empty-hx shouldn't reach here, but handle gracefully
    default:
      return {
        icon: <Folder className="h-8 w-8 text-foreground" strokeWidth={1.5} />,
        headline: "Set up your project",
        body: "Run the HX wizard to get started.",
      ...
      <div className="w-full max-w-lg">
        ...
        {detection.kind === "brownfield" && (
          <div className="mt-8 rounded-lg border border-border/50 bg-card/50 p-4">
            ...
            <ul className="mt-2.5 space-y-2">
              {[
                "HX scans your codebase and asks about your goals",
