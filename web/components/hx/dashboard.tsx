...
} from "@/components/hx/loading-skeletons"
import { ScopeBadge } from "@/components/hx/scope-badge"
import { ProjectWelcome } from "@/components/hx/project-welcome"
...
export function Dashboard({ onSwitchView, onExpandTerminal }: DashboardProps = {}) {
  ...
  // Show welcome screen for projects that aren't initialized with HX yet
