...
const KIND_STYLE: Record<ProjectDetectionKind, { label: string; color: string; icon: typeof Layers }> = {
  "active-hx": { label: "Active", color: "text-success", icon: Layers },
  "empty-hx": { label: "Initialized", color: "text-info", icon: FolderOpen },
...
export function StepProject({ onFinish, onBack, onBeforeSwitch }: StepProjectProps) {
  ...
  // Sort: active-hx first, then by name
  const sortedProjects = [...projects].sort((a, b) => {
    const kindOrder: Record<ProjectDetectionKind, number> = { "active-hx": 0, "empty-hx": 1, brownfield: 2, "v1-legacy": 3, blank: 4 }
              ...
              return (
                ...
                >
                  ...
                  <div className={cn(
                    ...
                    project.kind === "active-hx" ? "bg-success/10" : "bg-foreground/[0.04]",
                  )}>
                    {isSwitching ? (
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {/* Row 3: progress info (for active-hx projects) */}
                    {progress && (
                    ...
                    {/* Row 4: milestone bar (for active-hx with milestones) */}
