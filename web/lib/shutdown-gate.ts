 ...
 *
 * When HX_WEB_DAEMON_MODE=1, the server is running as a persistent daemon
...
export function isDaemonMode(): boolean {
  return process.env.HX_WEB_DAEMON_MODE === "1";
}
 ...
 *
 * No-op when HX_WEB_DAEMON_MODE=1 — the server should outlive any
