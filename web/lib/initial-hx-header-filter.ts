export type InitialHxHeaderFilterResult =
...
const TITLE_PATTERN = /HX — Hyperlab Coding Agent v\d+\.\d+\.\d+/i
...
/**
 * Strip the decorative HX startup banner from the beginning of a PTY stream.
 *
 ...
 */
export function filterInitialHxHeader(raw: string): InitialHxHeaderFilterResult {
