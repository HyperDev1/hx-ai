<overview>
Packaging extensions for distribution via npm, git, or local paths. Creating HX/pi packages.
</overview>
...
<installing>
```bash
hx install npm:@foo/bar@1.0.0
hx install git:github.com/user/repo@v1
