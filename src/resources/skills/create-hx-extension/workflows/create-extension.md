...
Ask the user:
- **Global** (`~/.hx/agent/extensions/`) — Available in all HX sessions
- **Project-local** (`.hx/extensions/`) — Available only in this project
...
```
~/.hx/agent/extensions/my-extension.ts
```

**Directory with index.ts** — for multi-file extensions:
```
~/.hx/agent/extensions/my-extension/
├── index.ts
├── tools.ts
└── utils.ts
```
...
Verify:
- Extension loads without errors (check HX startup output)
