/**
 * Shared UI design system for HX/interview TUI components.
 *
...
import { truncateToWidth, visibleWidth, wrapTextWithAnsi } from "@hyperlab/hx-tui";
...
export interface UI {
	...
	editorTheme: import("@hyperlab/hx-tui").EditorTheme;
}
...
export function makeUI(theme: Theme, width: number): UI {
	...
	const editorTheme: import("@hyperlab/hx-tui").EditorTheme = {
