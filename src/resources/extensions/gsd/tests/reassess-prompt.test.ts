...
// loadPrompt reads from ~/.hx/agent/extensions/gsd/prompts/ (main checkout).
...
test('reassess-roadmap prompt loads and substitutes', () => {
    const testVars = {
      ...
      assessmentPath: ".hx/milestones/M099/slices/S03/S03-ASSESSMENT.md",
      roadmapPath: ".hx/milestones/M099/M099-ROADMAP.md",
    ...
    assert.ok(result.includes(".hx/milestones/M099/slices/S03/S03-ASSESSMENT.md"), "prompt contains assessmentPath");
    assert.ok(result.includes(".hx/milestones/M099/M099-ROADMAP.md"), "prompt contains roadmapPath");
...
test('reassess-roadmap contains coverage-check instruction', () => {
    const prompt = loadPromptFromWorktree("reassess-roadmap", {
      ...
      assessmentPath: ".hx/milestones/M001/slices/S01/S01-ASSESSMENT.md",
