...
- **HX automatic verification and UAT generation**
...
### 7. Optimize for HX verification
...
This is the single most important missing capability for HX and autonomous QA.
...
- more robust HX verification of user flows
...
For HX and for hard UI debugging, you need failure evidence that survives the current context window.
...
- better HX verification records
...
# 16. Add HX-Native Verification Outputs

## Proposal

Make browser-tools able to emit outputs that directly support HX slice/task completion.

## Why it matters

You explicitly want browser tools to power automatic verification and testing during `@agent/extensions/hx/` use.
...
This is especially useful for HX artifacts.
...
- **automatic verification inside HX workflows**
