 ...
 *
 * LEAF NODE: This file must have ZERO imports from any HX module.
 * Only `node:` imports are permitted. All engine/policy interfaces
 * depend on these types; nothing here depends on HX internals.
 */
...
export interface EngineState {
  ...
  isComplete: boolean;
  /** Opaque engine-specific state — never narrowed to a HX-specific type. */
  raw: unknown;
}
