/**
 * HX Event Journal — structured JSONL event log for auto-mode iterations.
 *
 * Writes daily-rotated JSONL files to `.hx/journal/YYYY-MM-DD.jsonl`.
 ...
 *
 * File path: `<hxRoot>/journal/<YYYY-MM-DD>.jsonl`
