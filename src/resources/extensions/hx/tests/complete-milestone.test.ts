...
function createFixtureBase(): string {
  const base = mkdtempSync(join(tmpdir(), "hx-complete-ms-test-"));
...
describe("complete-milestone", () => {
  ...
  test("prompt variable substitution", () => {
    ...
    assert.ok(prompt.includes(".hx/milestones/M001/M001-ROADMAP.md"), "prompt contains roadmapPath");
  ...
  test("prompt content integrity", () => {
    const prompt = loadPromptFromWorktree("complete-milestone", {
      ...
      roadmapPath: ".hx/milestones/M002/M002-ROADMAP.md",
