...
function makeTask(overrides: Partial<HXTask> = {}): HXTask {
  return {
    id: 'T01',
    title: 'Setup Auth',
...
function makeSlice(overrides: Partial<HXSlice> = {}): HXSlice {
  return {
    id: 'S01',
    title: 'Auth System',
...
function makeMilestone(overrides: Partial<HXMilestone> = {}): HXMilestone {
  return {
    id: 'M001',
    title: 'Core Platform',
...
function makeSliceSummary(overrides: Partial<HXSliceSummaryData> = {}): HXSliceSummaryData {
  return {
...
function makeTaskSummary(overrides: Partial<HXTaskSummaryData> = {}): HXTaskSummaryData {
  return {
