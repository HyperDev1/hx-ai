...
const BASE_VARS = {
  ...
  slicePath: ".hx/milestones/M001/slices/S01",
  roadmapPath: ".hx/milestones/M001/M001-ROADMAP.md",
  researchPath: ".hx/milestones/M001/slices/S01/S01-RESEARCH.md",
  outputPath: "/tmp/test-project/.hx/milestones/M001/slices/S01/S01-PLAN.md",
  inlinedContext: "--- test inlined context ---",
  dependencySummaries: "", executorContextConstraints: "",
  sourceFilePaths: "- **Requirements**: `.hx/REQUIREMENTS.md`",
  skillActivation: "Load the relevant skills.",
};

const DEFAULT_SKILL_ACTIVATION = "If a `HX Skill Preferences` block is present in system context, use it and the `<available_skills>` catalog in your system prompt to decide which skills to load and follow for this unit, without relaxing required verification or artifact rules.";
...
test("plan-slice prompt: commit instruction says do not commit (external state)", () => {
  const result = loadPrompt("plan-slice", { ...BASE_VARS, commitInstruction: "Do not commit planning artifacts — .hx/ is managed externally." });
...
test("skillActivation default leaves no unresolved placeholder", () => {
  const result = loadPromptWithDefaultSkillActivation("execute-task", {
    ...
    planPath: ".hx/milestones/M001/slices/S01/S01-PLAN.md",
    taskPlanPath: ".hx/milestones/M001/slices/S01/tasks/T01-PLAN.md",
    taskPlanInline: "Task plan",
    slicePlanExcerpt: "Slice excerpt",
    carryForwardSection: "Carry forward",
    resumeSection: "Resume",
    priorTaskLines: "- (no prior tasks)",
    taskSummaryPath: "/tmp/test-project/.hx/milestones/M001/slices/S01/tasks/T01-SUMMARY.md",
...
test("research-milestone prompt substitutes skillActivation", () => {
  const result = loadPrompt("research-milestone", {
    ...
    milestonePath: ".hx/milestones/M001",
    contextPath: ".hx/milestones/M001/M001-CONTEXT.md",
    outputPath: "/tmp/test-project/.hx/milestones/M001/M001-RESEARCH.md",
...
test("research-slice prompt substitutes skillActivation", () => {
  const result = loadPrompt("research-slice", {
    ...
    roadmapPath: ".hx/milestones/M001/M001-ROADMAP.md",
    contextPath: ".hx/milestones/M001/M001-CONTEXT.md",
    milestoneResearchPath: ".hx/milestones/M001/M001-RESEARCH.md",
    outputPath: "/tmp/test-project/.hx/milestones/M001/slices/S01/S01-RESEARCH.md",
    inlinedContext: "Context",
    dependencySummaries: "",
    skillDiscoveryMode: "manual",
    skillDiscoveryInstructions: " Discover skills manually.",
...
test("plan-milestone prompt substitutes skillActivation", () => {
  const result = loadPrompt("plan-milestone", {
    ...
    milestonePath: ".hx/milestones/M001",
    contextPath: ".hx/milestones/M001/M001-CONTEXT.md",
    researchPath: ".hx/milestones/M001/M001-RESEARCH.md",
    researchOutputPath: "/tmp/test-project/.hx/milestones/M001/M001-RESEARCH.md",
    outputPath: "/tmp/test-project/.hx/milestones/M001/M001-ROADMAP.md",
    secretsOutputPath: "/tmp/test-project/.hx/milestones/M001/M001-SECRETS.md",
    inlinedContext: "Context",
...
test("guided plan milestone prompt substitutes skillActivation", () => {
  const result = loadPrompt("guided-plan-milestone", {
    milestoneId: "M001",
    milestoneTitle: "Test Milestone",
    secretsOutputPath: ".hx/milestones/M001/M001-SECRETS.md",
