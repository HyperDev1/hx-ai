...
Opts in to RTK shell-command compression. RTK is downloaded automatically on first use. Set `HX_RTK_DISABLED=1` to force-disable at the environment level regardless of this setting.
