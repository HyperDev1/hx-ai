...
/**
 * Write a report snapshot to .hx/reports/, update reports.json, regenerate index.html.
  ...
  <main>
    ...
    <section class="idx-cards">
      ...
      ${sorted.length > 0
        ...
        : '<p class="empty">No reports generated yet. Run <code>/hx export --html</code> or enable <code>auto_report: true</code>.</p>'}
    </section>
  </main>
</div>
