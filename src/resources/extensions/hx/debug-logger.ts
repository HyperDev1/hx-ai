// HX Extension — Debug Logger
// Structured JSONL debug logging for diagnosing stuck/slow HX sessions.
...
export function debugLog(event: string, data?: Record<string, unknown>): void {
  ...
  try {
    ...
    // Silently ignore write failures — debug logging must never break HX
  }
}
