// HX Migration Preview — Pre-write statistics
// Pure function, no I/O. Computes counts from a HXProject.

import type { HXProject } from './types.js';
import type { MigrationPreview } from './writer.js';

/**
 * Compute pre-write statistics from a HXProject without performing I/O.
 * Used to show the user what a migration will produce before writing anything.
 */
export function generatePreview(project: HXProject): MigrationPreview {
  let totalSlices = 0;
  let totalTasks = 0;
  let doneSlices = 0;
  let doneTasks = 0;
