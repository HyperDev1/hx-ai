/**
 * HX Slice Parallel Conflict Detection — File overlap analysis between slices.
 *
...
export function hasFileConflict(
  ...
  const planPathA = join(basePath, ".hx", "milestones", mid, sliceA, "PLAN.md");
  const planPathB = join(basePath, ".hx", "milestones", mid, sliceB, "PLAN.md");
