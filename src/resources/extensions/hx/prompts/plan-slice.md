...
1. Read the templates:
   - `~/.hx/agent/extensions/hx/templates/plan.md`
   - `~/.hx/agent/extensions/hx/templates/task-plan.md`
...
10. If planning produced structural decisions, append them to `.hx/DECISIONS.md`
