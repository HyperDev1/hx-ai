 ...
 *
 * Entry point: `runGitHubSync()` — called from the HX post-unit pipeline.
 * Routes to per-event sync functions based on the unit type, reads HX
...
/**
 * Main sync entry point — called from HX post-unit pipeline.
...
/**
 * Walk the `.hx/milestones/` tree and create GitHub entities for any
