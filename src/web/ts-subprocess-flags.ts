 ...
 * resolved under `node_modules/`. When HX is installed globally via npm,
 ...
 * with `--experimental-transform-types`.  When HX is installed globally via
 ...
 *
 * @param packageRoot  Absolute path to the HX package root.
...
/**
 * Builds the Node.js subprocess prefix args for running a HX extension module.
 *
