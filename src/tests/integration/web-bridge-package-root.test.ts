...
test("resolveBridgeRuntimeConfig uses HX_WEB_PACKAGE_ROOT when set", () => {
  const env = {
    HX_WEB_PACKAGE_ROOT: "/custom/package/root",
    HX_WEB_PROJECT_CWD: "/some/project",
...
test("resolveBridgeRuntimeConfig falls back to lazy default when HX_WEB_PACKAGE_ROOT is absent", () => {
