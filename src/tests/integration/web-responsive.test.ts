...
test('app-shell.tsx has a mobile hamburger menu toggle', () => {
  const src = readComponent('components/hx/app-shell.tsx')
...
test('sidebar.tsx supports a mobile prop', () => {
  const src = readComponent('components/hx/sidebar.tsx')
...
test('dashboard.tsx has responsive grid for metric cards', () => {
  const src = readComponent('components/hx/dashboard.tsx')
...
test('status-bar.tsx hides branch info on small screens', () => {
  const src = readComponent('components/hx/status-bar.tsx')
