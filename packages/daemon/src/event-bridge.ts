 ...
 *   - Conversation relay → Discord messages forwarded to HX sessions
...
import type { SdkAgentEvent } from '@hx-build/rpc-client';
...
export class EventBridge {
  ...
  private async handleMessageCreate(message: Message): Promise<void> {
    ...
    // Otherwise, relay the message to the HX session
