...
test("toPosixPath: handles .hx/worktrees path on Windows", () => {
	assert.equal(
		toPosixPath("C:\\Users\\name\\project\\.hx\\worktrees\\M001"),
		"C:/Users/name/project/.hx/worktrees/M001",
	);
});
...
test("buildSystemPrompt: no Windows absolute paths with backslashes in output", () => {
	...
	const prompt = buildSystemPrompt({
		cwd: "D:\\Projects\\my-app\\.hx\\worktrees\\M002",
	});
