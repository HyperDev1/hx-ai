...
const RISK_TIERS = {
  ...
  high: [
    'HX Workflow', 'Tool System', 'AI Providers', 'Extension Registry',
...
function parseMap(mapPath) {
  ...
  for (const line of lines) {
    ...
    // Skip bold section headers like **HX Extension (Core Workflow Engine)**
 ...
 *   - Glob prefix match:   hx/auto/*  matches  hx/auto/anything.ts
