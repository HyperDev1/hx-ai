...
> Ref: [#698](https://github.com/hx-build/hx-2/issues/698)
...
| **Storage location** | Session artifacts directory: `.hx/browser-state/<name>.json` |
...
- [ ] State files written to `.hx/browser-state/` and gitignored
...
| **Baseline management** | Save baselines to `.hx/browser-baselines/`; auto-name by URL + viewport |
