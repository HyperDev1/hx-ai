...
**Placement:**
- `~/.hx/agent/extensions/` (global)
- `.hx/extensions/` (project-local)
...
**Placement:**
- `~/.hx/agent/prompts/` (global)
- `.hx/prompts/` (project-local)
...
**Placement:**
- `~/.hx/agent/themes/` (global)
- `.hx/themes/` (project-local)
