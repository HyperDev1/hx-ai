...
| Location | Scope |
|----------|-------|
| `~/.hx/agent/extensions/*.ts` | Global (all projects) |
| `~/.hx/agent/extensions/*/index.ts` | Global (subdirectory) |
| `.hx/extensions/*.ts` | Project-local |
| `.hx/extensions/*/index.ts` | Project-local (subdirectory) |
